...
<div class="bg-[#FFE65E] px-4 py-16">
  <div class="max-w-6xl mx-auto">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 -mt-12 md:-mt-24">
      ...
      <!-- REPORT CARD -->
      <div class="flex flex-col items-center justify-center bg-white border-4 border-black p-6 min-h-[420px]">
        ...
        <h1 class="text-2xl font-bold mb-4">{{ $t('home.reportCard.title') }}</h1>
        <p class="text-sm mb-6 text-center max-w-xs">{{ $t('home.reportCard.description') }}</p>
        <nuxt-link to="/report-stray">
          <button class="bg-[#3D6625] text-black font-bold text-sm w-40 md:w-52 py-3">
            {{ $t('home.reportCard.button') }}
          </button>
        </nuxt-link>
      </div>
      ...
      <div class="flex flex-col items-center justify-center bg-white border-4 border-black p-6 min-h-[420px]">
        ...
        <h1 class="text-2xl font-bold mb-4">{{ $t('home.adoptCard.title') }}</h1>
        <p class="text-sm mb-6 text-center max-w-xs">{{ $t('home.adoptCard.description') }}</p>
        <nuxt-link to="/up-for-adoption">
          <button class="bg-[#3D6625] text-black font-bold text-sm w-40 md:w-52 py-3">
            {{ $t('home.adoptCard.button') }}
          </button>
        </nuxt-link>
      </div>
      ...
      <div class="flex flex-col items-center justify-center bg-white border-4 border-black p-6 min-h-[420px]">
        ...
        <h1 class="text-2xl font-bold mb-4">{{ $t('home.donateCard.title') }}</h1>
        <p class="text-sm mb-6 text-center max-w-xs">{{ $t('home.donateCard.description') }}</p>
        <nuxt-link to="/support">
          <button class="bg-[#3D6625] text-black font-bold text-sm w-40 md:w-52 py-3">
            {{ $t('home.donateCard.button') }}
          </button>
        </nuxt-link>
      </div>
...
<!-- END OF CARDS -->
<!-- INTRODUCTION -->
<section class="bg-[#FFFADF] py-12 px-4 md:py-20 md:px-8">
  <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
    ...
    <!-- TEXT + BUTTONS with dashed left border on md+ -->
    <div
    ...
    >
      ...
      <div class="flex flex-col sm:flex-row items-center gap-4 sm:gap-8">
        <nuxt-link to="/support">
          <button class="bg-[#FFD700] text-black font-bold text-sm sm:text-base px-6 py-3">
            {{ $t('home.intro.supportButton') }}
          </button>
        </nuxt-link>
        <nuxt-link to="/volunteer">
          <button class="bg-[#FFD700] text-black font-bold text-sm sm:text-base px-6 py-3">
            {{ $t('home.intro.volunteerButton') }}
          </button>
        </nuxt-link>
      </div>
    </div>
...
<section class="bg-[#FAF8ED] py-16 px-4 md:px-0">
  <div class="max-w-6xl mx-auto">
...
>>>>>>> Stashed changes
      ...
      <div class="w-full md:w-1/2">
        <div class="relative w-full aspect-[4/3] rounded overflow-hidden shadow-lg">
          <iframe
